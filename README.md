...
- **録音機能**: 内蔵マイク録音機能
- **GUI/TUI対応**: グラフィカル画面とターミナル画面の両対応（TUIはmacOS専用）
...
1. **ダウンロード**:
   - **Apple Silicon (M1/M2/M3)**: `koemoji-go-macos-1.8.1.tar.gz`
...
>   - ⚠️ **ヘッドホン/イヤホン推奨**: スピーカーの音をマイクが拾い、システム音声が二重に録音される場合があります
